...
private ProfilePictureDao profilePictureDao;
	...
	public @ResponseBody byte[] getImage(@PathVariable String email,HttpSession session){
		String auth=(String)session.getAttribute("loginId"); //email of loggedInUser 
		if(auth==null){
			return null;
		}
		System.out.println(email);
		ProfilePicture profilePicture=profilePictureDao.getProfilePicture(email); // email of individual user other than loggedInUser
